...
\CommentTok{#> $stats}
\CommentTok{#>             [,1]}
\CommentTok{#> [1,] -1.29302702}
\CommentTok{#> [2,] -0.28751528}
\CommentTok{#> [3,]  0.06033321}
\CommentTok{#> [4,]  0.71782818}
\CommentTok{#> [5,]  1.26954965}
\CommentTok{#> }
\CommentTok{#> $n}
\CommentTok{#> [1] 20}
\CommentTok{#> }
\CommentTok{#> $conf}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -0.2948534}
\CommentTok{#> [2,]  0.4155198}
\CommentTok{#> }
\CommentTok{#> $out}
\CommentTok{#> [1] -2.6431}
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> $counts}
\CommentTok{#>  [1]   1  11  16  28 101 156 193 191 147  88  41  19   7   0   1}
\CommentTok{#> }
\CommentTok{#> $density}
\CommentTok{#>  [1] 0.002 0.022 0.032 0.056 0.202 0.312 0.386 0.382 0.294 0.176 0.082 0.038}
\CommentTok{#> [13] 0.014 0.000 0.002}
\CommentTok{#> }
\CommentTok{#> $mids}
\CommentTok{#>  [1] -3.25 -2.75 -2.25 -1.75 -1.25 -0.75 -0.25  0.25  0.75  1.25  1.75  2.25}
\CommentTok{#> [13]  2.75  3.25  3.75}
\CommentTok{#> }
\CommentTok{#> $xname}
\CommentTok{#> [1] "var6"}
\CommentTok{#> }
