...
\CommentTok{#>  [1]  8  3  2  2  9  3  5  5  7  6 10  7  8  4  3  7  1  6  6  2}
...
\CommentTok{#>  [1] 11 13 11 10 16 16 12 14 15 20 14 12 15 16 17 10 13 10 19 11}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#>  [1] -1.683585022 -0.390552469 -0.021185514 -1.314088977  0.941554777}
\CommentTok{#>  [6]  0.302050842  0.967869334 -0.895130091  0.788909965  1.655221646}
\CommentTok{#> [11]  0.121147195 -0.993488810  1.179651057 -0.009870677  0.533769860}
\CommentTok{#> [16] -0.956857241  0.936392341 -0.135503465 -0.712642251 -0.288095170}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> $stats}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -1.6835850}
\CommentTok{#> [2,] -0.8038862}
\CommentTok{#> [3,] -0.0155281}
\CommentTok{#> [4,]  0.8626512}
\CommentTok{#> [5,]  1.6552216}
\CommentTok{#> }
\CommentTok{#> $n}
\CommentTok{#> [1] 20}
\CommentTok{#> }
\CommentTok{#> $conf}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -0.6043136}
\CommentTok{#> [2,]  0.5732574}
\CommentTok{#> }
\CommentTok{#> $out}
...
\CommentTok{#>  [1] "Blanc" "Noir"  "Blanc" "Bleu"  "Noir"  "Rouge" "Noir"  "Bleu"  "Rouge"}
\CommentTok{#> [10] "Bleu"  "Jaune" "Noir"  "Rouge" "Blanc" "Blanc" "Jaune" "Rouge" "Jaune"}
...
\CommentTok{#>   154   154   166   184   170   172}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-51-1} \end{center}
...
\CommentTok{#> echn}
\CommentTok{#> Blanc  Bleu Jaune  Noir Rouge  Vert }
\CommentTok{#> 0.154 0.154 0.166 0.184 0.170 0.172}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-54-1} \end{center}
...
\CommentTok{#>  [1]  0.19359751  0.96029622  0.54074423 -0.72409945  0.75019699 -0.58318593}
\CommentTok{#>  [7]  1.14004002  0.39983284  0.15731241  0.44523979 -0.57196975  1.33313527}
\CommentTok{#> [13] -1.33786090  0.26980298  0.69867018  0.47619594  0.01923574 -1.95193093}
\CommentTok{#> [19] -0.44230633  0.63921757}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#> $breaks}
\CommentTok{#>  [1] -3.0 -2.5 -2.0 -1.5 -1.0 -0.5  0.0  0.5  1.0  1.5  2.0  2.5  3.0  3.5  4.0}
\CommentTok{#> }
\CommentTok{#> $counts}
\CommentTok{#>  [1]   4  20  35 103 155 205 189 154  82  34  13   3   2   1}
\CommentTok{#> }
\CommentTok{#> $density}
\CommentTok{#>  [1] 0.008 0.040 0.070 0.206 0.310 0.410 0.378 0.308 0.164 0.068 0.026 0.006}
\CommentTok{#> [13] 0.004 0.002}
\CommentTok{#> }
\CommentTok{#> $mids}
\CommentTok{#>  [1] -2.75 -2.25 -1.75 -1.25 -0.75 -0.25  0.25  0.75  1.25  1.75  2.25  2.75}
\CommentTok{#> [13]  3.25  3.75}
\CommentTok{#> }
\CommentTok{#> $xname}
\CommentTok{#> [1] "var6"}
\CommentTok{#> }
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-58-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-60-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-61-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-116-1} \end{center}
...
\begin{center}\includegraphics[width=.9\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-117-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-118-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-119-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-121-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-123-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-126-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-131-1} \end{center}
...
\begin{center}\includegraphics[width=.6\linewidth]{visualiseR_files/figure-latex/unnamed-chunk-133-1} \end{center}
...
\CommentTok{#> <bytecode: 0x55862bca7a00>}
