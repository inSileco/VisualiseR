...
\CommentTok{#> $stats}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -1.4145538}
\CommentTok{#> [2,] -0.2117814}
\CommentTok{#> [3,]  0.3092691}
\CommentTok{#> [4,]  1.1336609}
\CommentTok{#> [5,]  1.5167490}
\CommentTok{#> }
\CommentTok{#> $n}
\CommentTok{#> [1] 20}
\CommentTok{#> }
\CommentTok{#> $conf}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -0.1660740}
\CommentTok{#> [2,]  0.7846121}
\CommentTok{#> }
\CommentTok{#> $out}
...
\CommentTok{#> $breaks}
\CommentTok{#>  [1] -4.0 -3.5 -3.0 -2.5 -2.0 -1.5 -1.0 -0.5  0.0  0.5  1.0  1.5  2.0  2.5  3.0}
\CommentTok{#> [16]  3.5}
\CommentTok{#> }
\CommentTok{#> $counts}
\CommentTok{#>  [1]   1   2   4  21  40  77 133 192 204 161 104  35  19   5   2}
\CommentTok{#> }
\CommentTok{#> $density}
\CommentTok{#>  [1] 0.002 0.004 0.008 0.042 0.080 0.154 0.266 0.384 0.408 0.322 0.208 0.070}
\CommentTok{#> [13] 0.038 0.010 0.004}
\CommentTok{#> }
\CommentTok{#> $mids}
\CommentTok{#>  [1] -3.75 -3.25 -2.75 -2.25 -1.75 -1.25 -0.75 -0.25  0.25  0.75  1.25  1.75}
\CommentTok{#> [13]  2.25  2.75  3.25}
\CommentTok{#> }
\CommentTok{#> $xname}
\CommentTok{#> [1] "var6"}
\CommentTok{#> }
