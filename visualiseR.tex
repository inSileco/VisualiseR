...
\CommentTok{#> $stats}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -1.4356351}
\CommentTok{#> [2,] -0.6038024}
\CommentTok{#> [3,] -0.1878678}
\CommentTok{#> [4,]  0.4312324}
\CommentTok{#> [5,]  1.5848625}
\CommentTok{#> }
\CommentTok{#> $n}
\CommentTok{#> [1] 20}
\CommentTok{#> }
\CommentTok{#> $conf}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -0.5535443}
\CommentTok{#> [2,]  0.1778087}
\CommentTok{#> }
\CommentTok{#> $out}
\CommentTok{#> [1] -2.465385}
\CommentTok{#> }
\CommentTok{#> $group}
\CommentTok{#> [1] 1}
\CommentTok{#> }
...
\CommentTok{#> }
\CommentTok{#> $counts}
\CommentTok{#>  [1]   3   7  15  46  89 155 166 186 167  96  44  25   0   1}
\CommentTok{#> }
\CommentTok{#> $density}
\CommentTok{#>  [1] 0.006 0.014 0.030 0.092 0.178 0.310 0.332 0.372 0.334 0.192 0.088 0.050}
\CommentTok{#> [13] 0.000 0.002}
\CommentTok{#> }
\CommentTok{#> $mids}
