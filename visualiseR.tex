...
\CommentTok{#> $stats}
\CommentTok{#>             [,1]}
\CommentTok{#> [1,] -2.00555997}
\CommentTok{#> [2,] -0.76362286}
\CommentTok{#> [3,] -0.01297328}
\CommentTok{#> [4,]  0.61840230}
\CommentTok{#> [5,]  2.30234249}
\CommentTok{#> }
\CommentTok{#> $n}
\CommentTok{#> [1] 20}
\CommentTok{#> }
\CommentTok{#> $conf}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -0.5012410}
\CommentTok{#> [2,]  0.4752945}
\CommentTok{#> }
\CommentTok{#> $out}
...
\CommentTok{#> }
\CommentTok{#> $counts}
\CommentTok{#>  [1]   3   2  11  56  82 147 203 191 145  95  42  15   7   1}
\CommentTok{#> }
\CommentTok{#> $density}
\CommentTok{#>  [1] 0.006 0.004 0.022 0.112 0.164 0.294 0.406 0.382 0.290 0.190 0.084 0.030}
\CommentTok{#> [13] 0.014 0.002}
\CommentTok{#> }
\CommentTok{#> $mids}
