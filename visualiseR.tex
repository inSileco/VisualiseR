...
\CommentTok{#> $stats}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -1.6698549}
\CommentTok{#> [2,] -0.6734527}
\CommentTok{#> [3,] -0.1364490}
\CommentTok{#> [4,]  0.7345330}
\CommentTok{#> [5,]  1.1285671}
\CommentTok{#> }
\CommentTok{#> $n}
\CommentTok{#> [1] 20}
\CommentTok{#> }
\CommentTok{#> $conf}
\CommentTok{#>            [,1]}
\CommentTok{#> [1,] -0.6338886}
\CommentTok{#> [2,]  0.3609906}
\CommentTok{#> }
\CommentTok{#> $out}
...
\CommentTok{#> $breaks}
\CommentTok{#> [1] -4 -3 -2 -1  0  1  2  3  4}
\CommentTok{#> }
\CommentTok{#> $counts}
\CommentTok{#> [1]   5  21 144 335 335 137  20   3}
\CommentTok{#> }
\CommentTok{#> $density}
\CommentTok{#> [1] 0.005 0.021 0.144 0.335 0.335 0.137 0.020 0.003}
\CommentTok{#> }
\CommentTok{#> $mids}
\CommentTok{#> [1] -3.5 -2.5 -1.5 -0.5  0.5  1.5  2.5  3.5}
\CommentTok{#> }
\CommentTok{#> $xname}
\CommentTok{#> [1] "var6"}
\CommentTok{#> }
