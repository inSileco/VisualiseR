...
## Premier graphe
par(cex.axis = .75, ann = F)
plot(x, y1, col = "steelblue", type = "h", lwd = 5, ylim = c(0, 2000), axes = F, xlim = c(0, 1550))
axis(1, pos = 0, seq(0, 1500, 500), seq(0, 1500, 500))
axis(2, pos = 0, seq(0, 2000, 500), seq(0, 2000, 500), las = 1)
## Second graphe
par(new = TRUE)
plot(x, y2, type = "l", col = "red", lwd = 2, ann = F, ylim = c(0, 30), axes = F, xlim = c(0, 1550))
...
y1 <- sort(y1, decreasing = T)
## Premier graphe
par(cex.axis = .75, ann = F, mar = c(1,1,1,1))
plot(x, y1, col = "steelblue", type = "h", lwd = 5, ylim = c(0, 2000), axes = F, xlim = c(0, 1550))
axis(1, pos = 0, seq(0, 1500, 500), seq(0, 1500, 500))
axis(2, pos = 0, seq(0, 2000, 500), seq(0, 2000, 500), las = 1)
## Second graphe
...
```{r eval = FALSE}
par(fig = c(.5, 1, .5, 1), new = T)
```

Et pour un médaillon placé au centre,

```{r eval = FALSE}
par(fig = c(.25, .75, .25, .75), new = T)
```
...
plot(c(0, 5), c(0, 5), xaxt = "n", yaxt = "n", ann = F , type = "n")
rect(0, 0, 5, 5, col = "#0000FF7D")
points(sample(1:4, 10, replace = T), sample(1:4, 10, replace = T), col = "#FF00007D", pch = 15, cex = 5)
axis(3, at = 0:5, 0:5, col = par()$col.axis)
axis(4, at = 0:5, 0:5, col = par()$col.axis, las = 1)
par(fig = c(0, .55, 0, .55), mar = c(2, 2, 0, 0), xaxs = "i", yaxs = "i", mgp = c(0, .75, 0), cex.axis = .75, new = T)
plot(c(0, 5), c(0, 5), xaxt = "n", yaxt = "n", ann = F , type = "n")
rect(0, 0, 5, 5, col = "#FF00007D")
points(sample(1:4, 10, replace = T), sample(1:4, 10, replace = T), col = "#0000FF7D", pch = 19, cex = 5)
axis(1, at = 0:5, 0:5, col = par()$col.axis)
axis(2, at = 0:5, 0:5, col = par()$col.axis, las = 1)
box("outer", col = "white")
```
