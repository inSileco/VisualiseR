...
```{r echo = FALSE, out.width = '.9\\linewidth'}
###
### APERO
###
...
plot(x = 0, type = "n", xlim = c(0, 40), ylim = c(0, 40), axes = F, ann = F)
# Background
...
plot(x = 0, type = "n", xlim = c(0, 40), ylim = c(0, .2), axes = F, ann = F)
# Background
...
plot(x = 0, type = "n", xlim = c(0, .3), ylim = c(0, 40), axes = F, ann = F)
# Background
...
plot(x = 0, type = "n", ylim = c(0, 4), xlim = c(0, 4), axes = F, ann = F)
# Background
...
plot(x = 0, type = "n", xlim = c(0, 30), ylim = c(0, 40), axes = F, ann = F)
# Background
...
#hist(dat, add = T, border = "#32A74F7D", col = "#32A74F7D", breaks = seq(2, 24, by = 2))
hist(dat, add = T, border = "#0000007D", col = "#0000007D", breaks = seq(2, 24, by = 2))
###
...
plot(x = 0, type = "n", xlim = c(0, 30), ylim = c(0, .2), axes = F, ann = F)
# Axes principaux
axis(side = 4, pos = 30, at = seq(0, .2, .05), labels = format(seq(0, .2, .05)), col = par()$col.axis, font = 2, las = 2)
axis(side = 4, pos = 30, at = seq(0.025, .175, .05), labels = F, lwd = 0, tck = -0.01, lwd.ticks = 1, col.ticks = par()$col.axis)
...
###
# Empty plot
par(mar = c(2.5, 2.5, 3, 3), family = "serif", col.axis = "#555555", new = T, fig = c(.5, 1, .5, 1), mgp = c(0, .5, 0), cex.axis = .75)
plot(x = 0, type = "n", xlim = c(0, 30), ylim = c(0, .2), axes = F, ann = F)
# Background
...
# Axes secondaires
axis(side = 2, pos = 0, at = seq(0.025, .175, .05), labels = F, lwd = 0, tck = -0.02, lwd.ticks = 1, col.ticks = par()$col.axis)
# Ajout de la courbe de densite
polygon(density(dat)$x, density(dat)$y, col = "#2B84B67D", border = "#2B84B67D", lwd = 2)
```
