...
l'approche développée dans le package _graphics_, celle du package _grid_ (qui inclus ggplot2) et une troisième, hétérogène, qui est l'ensemble des libraries qui utilisent d'autres languages, par exemple, javascript (et ainsi créer des figures dans un navigateur web).
