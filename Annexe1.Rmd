...
R a été capable de comprendre et d'indexer en mémoire ces différents objets. Ce dernier point enlève une épine du pied de l'utilisateur de R[^lang1]. Nous pouvons savoir comment R a interprété ces objets avec la fonction \texttt{typeof()}[^lang2].
...
L'exemple suivant montre comment profiter des arguments supplémentaires, "...". Nous créons la fonction \texttt{affinen()} qui retourne la valeur de la fonction affine à la puissance n. Nous pourions ré-écrire l'ensemble des paramètre de la fonction affine mais nous pouvons aussi utiliser les "...", de la sorte :
...
[^lang2]:Il est possible d'utiliser la fonction \texttt{mode()} qui est simplement un alias de cette fonction.
