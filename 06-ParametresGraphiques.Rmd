...
Abordons tout d'abord la notion de fonte de caractères. En typographie, une fonte de caractères est un ensemble de règles qui va déterminer le rendu visuel d'une expression textuelle. Il est très fréquent que police et fonte soient confondues. Une fonte de caractère est caracterisée par :
...
De nombreuses classifications existent pour les polices de caractères. Celle que nous présentons ici à l'avantage de se rapprocher des polices disponibles
dans R (et dans le monde du Web).
...
```{r echo=-c(4, 7, 10, 13), out.width = '.6 | linewidth'}
...
```{r echo = -c(1, 14), out.width = '.6 | linewidth'}
par(bg = "lightgray")
...
```{r echo=-c(1, 6), fig.width = 10,fig.height = 5, out.width = '.5 | linewidth'}
...
```{r echo=-c(1, 5), out.width = '.5 | linewidth'}
par(bg = "lightgray", family = "serif")
k <- 1
...
```{r warning = FALSE, echo = FALSE, out.width = '.8 | linewidth'}
par(mar = c(1, 1, 1, 1), bg = "lightgray")
plot(0, xlim = c(1, 10), ylim = c(1, 12), axes = FALSE, ann = F)
for (i in 1 : 12){
...
```{r echo = FALSE, fig.width = 10,fig.height = 5, out.width = '.5 | linewidth'}
par(bg = "lightgray", family = "serif")
x <- rnorm(50)
y <- rnorm(50)
plot(x, y, type = "n", ann = FALSE, bty = "n", las = 1)
...
```{r warning = FALSE, echo = FALSE, out.width = '.8 | linewidth'}
par(mar = c(1, 1, 1, 1), bg = "lightgray")
plot(0, xlim = c(1, 10), ylim = c(1, 18), axes = FALSE, ann = F)
for (i in 1 : 6){
...
```{r warning=F, echo = -c(1, 4, 8, 12, 16), out.width = '.5 | linewidth'}
...
```{r warning = FALSE, echo = FALSE, out.width = '.5 | linewidth'}
...
mtext(side = 3, line = 1.75, text = "mar", col = "blue", font = 2)
box("outer", col = "darkgreen", lwd = 4)
mtext(side = 3, line = 0.5, text = "oma", col = "darkgreen", font = 2, outer = T)
```

```{r warning=F, echo = FALSE, fig.width = 10,fig.height = 5, out.width = '.6 | linewidth'}
par(oma = c(2, 2, 2, 2), bg = "lightgray", mfrow = c(1, 2))
par(family = "mono")
plot(0, 0, type = "n", xlab = "Axe des x", ylab = "Axe des y")
box("plot", col = "red", lwd = 2)
...
```{r warning=F, echo = FALSE, fig.width = 10,fig.height = 10, out.width = '.6 | linewidth'}
par(mfrow = c(2, 2), bg = "lightgray", family = "serif")
plot(0, pch = 15, main = "'mar' par défaut")
box("figure", lwd = 2)
box("plot", col = "red", lwd = 2)
...
A la différence du système binaire (système reposant sur une base 2 [0 et 1]), le système hexadécimal utilise 16 symboles : les dix chiffres arabes et les six premières lettres de l'alphabet (de A a F). Le tableau suivant donne la correspondance avec le systeme décimal.
...
```{r echo = FALSE, fig.width = 10,fig.height = 2, out.width = '1 | linewidth'}
par(mar = c(0, 0, 0, 0), mfrow = c(2, 1))
image(matrix(1:255, ncol = 1), col = rainbow(255), axes = F)
box("figure", lwd = 2)
image(matrix(c(0:255), ncol = 1), col = gray(c(0:255)/255), axes = F)
...
```{r echo = FALSE, fig.width = 10, fig.height = 1, out.width = '.8 | linewidth'}
switch(.Platform$OS.type,
unix = {quartz(width = 7, height = .5)},
windows = {x11(width = 7, height = .5)})
par(mar = c(0, 0, 0, 0))
